...
<head>
  <title> <?php echo $_GET['Department'] ?> </title>
        ...
        <div class="container-fluid">
          <table class="table">
            <tbody>
              ...
              echo $str = "
              <tr>
                <td> <a href='DoctorsByDepartment.php?Department=" . $_GET['Department'] . "' class='btn btn-warning'>Doctors List</a></td>
                <td> <a href='DoctorsRankingForRecommendation.php?Department=" . $_GET['Department'] . "' class='btn btn-warning'>Recommended doctor with Ranking</a></td>
              </tr>"
              ?>
            </tbody>
          </table>
